 ...
 */
@Component
 public class Test extends BaseResource {
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("test");
	...
	static {
		...
		Field fileField = new Field("file", "String");
		fileField.setFile(true);
		metaData.addField(fileField);
	...
	public Test() {this.setId(Util.getUniqueId());}
	public Test(String id) {this.setId(id);}
	...
	public  Class<?> getResultClass() {return TestResult.class;};
	public  Class<?> getMessageClass() {return TestMessage.class;};
	public  Class<?> getHelperClass() {return TestHelper.class;};
	public  Class<?> getServiceClass() {return TestService.class;};
}