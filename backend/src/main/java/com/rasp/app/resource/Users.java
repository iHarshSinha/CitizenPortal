...
@Component
 public class Users extends BaseResource {
	...
	public static String FIELD_USER_EMAIL = "user_email";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("Users");
	...
	static {
		...
		Field user_emailField = new Field("user_email", "String");
		user_emailField.setRequired(true);
		metaData.addField(user_emailField);
	...
	public Users() {this.setId(Util.getUniqueId());}
	public Users(String id) {this.setId(id);}
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object user_emailObj = map.get("user_email");
		if(user_emailObj != null)
			user_email = user_emailObj.toString();
	...
	public void unSetUser_email() {
		this.user_email = null;
	}

	public boolean validateUser_email(boolean add) throws ApplicationException {
		if(add && user_email == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[user_email]");
	...
	public  Class<?> getResultClass() {return UsersResult.class;};
	public  Class<?> getMessageClass() {return UsersMessage.class;};
	public  Class<?> getHelperClass() {return UsersHelper.class;};
	public  Class<?> getServiceClass() {return UsersService.class;};
}