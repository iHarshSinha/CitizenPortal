...
@Component
 public class Department extends BaseResource {
	...
	private String dept_email = null;
	...
	public static String FIELD_DEPT_ID = "dept_id";
	public static String FIELD_DEPT_NAME = "dept_name";
	public static String FIELD_DEPT_EMAIL = "dept_email";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("department");
	...
	static {
		...
		Field dept_idField = new Field("dept_id", "Long");
		dept_idField.setRequired(true);
		metaData.addField(dept_idField);

		Field dept_nameField = new Field("dept_name", "String");
		dept_nameField.setRequired(true);
		metaData.addField(dept_nameField);

		Field dept_emailField = new Field("dept_email", "String");
		dept_emailField.setRequired(true);
		metaData.addField(dept_emailField);
		...
		metaData.setTableName("department");

		metaData.setCluster("rasp_db");
	}

	public Department() {this.setId(Util.getUniqueId());}
	public Department(String id) {this.setId(id);}
	...
	public Department(Department obj) {
		...
		this.dept_name = obj.dept_name;
		this.dept_email = obj.dept_email;
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateDept_id(add))
			map.put("dept_id", dept_id);
		if(validateDept_name(add))
			map.put("dept_name", dept_name);
		if(validateDept_email(add))
			map.put("dept_email", dept_email);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		dept_id = (map.get("dept_id") == null ? null : ((Number) map.get("dept_id")).longValue());
		dept_name = (String) map.get("dept_name");
		dept_email = (String) map.get("dept_email");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object dept_idObj = map.get("dept_id");
		if(dept_idObj != null)
			dept_id = new Long(dept_idObj.toString());

		Object dept_nameObj = map.get("dept_name");
		if(dept_nameObj != null)
			dept_name = dept_nameObj.toString();

		Object dept_emailObj = map.get("dept_email");
		if(dept_emailObj != null)
			dept_email = dept_emailObj.toString();
	...
	public boolean validateDept_id(boolean add) throws ApplicationException {
		if(add && dept_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[dept_id]");
		return dept_id != null;
	}
	...
	public boolean validateDept_name(boolean add) throws ApplicationException {
		if(add && dept_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[dept_name]");
		return dept_name != null;
	}
	...
	public String getDept_emailEx() {
		return dept_email != null ? dept_email : "";
	}
	...
	public void unSetDept_email() {
		this.dept_email = null;
	}

	public boolean validateDept_email(boolean add) throws ApplicationException {
		if(add && dept_email == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[dept_email]");
		return dept_email != null;
	}
	...
	public  Class<?> getResultClass() {return DepartmentResult.class;};
	public  Class<?> getMessageClass() {return DepartmentMessage.class;};
	public  Class<?> getHelperClass() {return DepartmentHelper.class;};
	public  Class<?> getServiceClass() {return DepartmentService.class;};
}