 ...
 */
@Component
 public class Citizen extends BaseResource {
	...
	private Long citizen_id = null;
	private String aadhar_id = null;
	...
	public static String FIELD_CITIZEN_ID = "citizen_id";
	public static String FIELD_AADHAR_ID = "aadhar_id";
	...
	public final static ResourceMetaData metaData = new ResourceMetaData("citizen");
	...
	static {
		...
		Field citizen_idField = new Field("citizen_id", "Long");
		citizen_idField.setRequired(true);
		metaData.addField(citizen_idField);

		Field aadhar_idField = new Field("aadhar_id", "String");
		aadhar_idField.setRequired(true);
		metaData.addField(aadhar_idField);

		Field nameField = new Field("name", "String");
		nameField.setRequired(true);
		metaData.addField(nameField);

		Field dobField = new Field("dob", "Date");
		dobField.setRequired(true);
		metaData.addField(dobField);

		Field genderField = new Field("gender", "String");
		genderField.setEnum(true);
		genderField.setPossible_value("Gender");
		genderField.setRequired(true);
		metaData.addField(genderField);

		Field phone_noField = new Field("phone_no", "String");
		phone_noField.setRequired(true);
		...
		metaData.setTableName("citizen");

		metaData.setCluster("rasp_db");
	}

	public Citizen() {this.setId(Util.getUniqueId());}
	public Citizen(String id) {this.setId(id);}

	public Citizen(Citizen obj) {
		this.id = obj.id;
	...
	public Map<String, Object> convertResourceToMap(HashMap<String, Object> map) {
		...
		if(citizen_id != null)
			map.put("citizen_id", citizen_id);
		if(aadhar_id != null)
			map.put("aadhar_id", aadhar_id);
		if(name != null)
			map.put("name", name);
		if(dob != null)
			map.put("dob", dob);
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateCitizen_id(add))
			map.put("citizen_id", citizen_id);
		if(validateAadhar_id(add))
			map.put("aadhar_id", aadhar_id);
		if(validateName(add))
			map.put("name", name);
		if(validateDob(add))
			map.put("dob", dob);
		if(validateGender(add))
			map.put("gender", gender);
		if(validatePhone_no(add))
			map.put("phone_no", phone_no);
		if(email != null)
			map.put("email", email);
		if(extra_data != null)
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		citizen_id = (map.get("citizen_id") == null ? null : ((Number) map.get("citizen_id")).longValue());
		aadhar_id = (String) map.get("aadhar_id");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object citizen_idObj = map.get("citizen_id");
		if(citizen_idObj != null)
			citizen_id = new Long(citizen_idObj.toString());

		Object aadhar_idObj = map.get("aadhar_id");
		if(aadhar_idObj != null)
			aadhar_id = aadhar_idObj.toString();
	...
	public void unSetCitizen_id() {
		this.citizen_id = null;
	}

	public boolean validateCitizen_id(boolean add) throws ApplicationException {
		if(add && citizen_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[citizen_id]");
		return citizen_id != null;
	}
	...
	public String getAadhar_idEx() {
		return aadhar_id != null ? aadhar_id : "";
	}
	...
	public void unSetAadhar_id() {
		this.aadhar_id = null;
	}

	public boolean validateAadhar_id(boolean add) throws ApplicationException {
		if(add && aadhar_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[aadhar_id]");
		return aadhar_id != null;
	}
	...
	public boolean validateDob(boolean add) throws ApplicationException {
		if(add && dob == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[dob]");
		return dob != null;
	}
	...
	public boolean validateGender(boolean add) throws ApplicationException {
		if(add && gender == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[gender]");
		return gender != null;
	}
	...
	public boolean validatePhone_no(boolean add) throws ApplicationException {
		if(add && phone_no == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[phone_no]");
	...
	public  Class<?> getResultClass() {return CitizenResult.class;};
	public  Class<?> getMessageClass() {return CitizenMessage.class;};
	public  Class<?> getHelperClass() {return CitizenHelper.class;};
	public  Class<?> getServiceClass() {return CitizenService.class;};
}