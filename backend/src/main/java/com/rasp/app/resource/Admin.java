...
@Component
 public class Admin extends BaseResource {
	...
	public static String FIELD_ADMIN_ID = "admin_id";
	public static String FIELD_ADMIN_NAME = "admin_name";
	public static String FIELD_ADMIN_EMAIL = "admin_email";
	public static String FIELD_EXTRA_DATA = "extra_data";

	private static final long serialVersionUID = 1L;
	public final static ResourceMetaData metaData = new ResourceMetaData("admin");
	...
	static {
		...
		Field admin_idField = new Field("admin_id", "Long");
		admin_idField.setRequired(true);
		metaData.addField(admin_idField);

		Field admin_nameField = new Field("admin_name", "String");
		admin_nameField.setRequired(true);
		metaData.addField(admin_nameField);

		Field admin_emailField = new Field("admin_email", "String");
		admin_emailField.setRequired(true);
		metaData.addField(admin_emailField);
		...
		metaData.setTableName("admin");

		metaData.setCluster("rasp_db");
	}

	public Admin() {this.setId(Util.getUniqueId());}
	public Admin(String id) {this.setId(id);}
	...
	public Map<String, Object> validateAndConvertResourceToMap(HashMap<String,Object> map,boolean add) throws ApplicationException {
		...
		if(archived_time != null)
			map.put("archived_time", archived_time);
		if(validateAdmin_id(add))
			map.put("admin_id", admin_id);
		if(validateAdmin_name(add))
			map.put("admin_name", admin_name);
		if(validateAdmin_email(add))
			map.put("admin_email", admin_email);
		if(extra_data != null)
			map.put("extra_data", extra_data);
		return map;
	...
	public void convertMapToResource(Map<String, Object> map) {
		...
		admin_id = (map.get("admin_id") == null ? null : ((Number) map.get("admin_id")).longValue());
		admin_name = (String) map.get("admin_name");
		admin_email = (String) map.get("admin_email");
	...
	public void convertTypeUnsafeMapToResource(Map<String, Object> map) {
		...
		Object admin_idObj = map.get("admin_id");
		if(admin_idObj != null)
			admin_id = new Long(admin_idObj.toString());

		Object admin_nameObj = map.get("admin_name");
		if(admin_nameObj != null)
			admin_name = admin_nameObj.toString();

		Object admin_emailObj = map.get("admin_email");
		if(admin_emailObj != null)
			admin_email = admin_emailObj.toString();
	...
	public boolean validateAdmin_id(boolean add) throws ApplicationException {
		if(add && admin_id == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[admin_id]");
	...
	public String getAdmin_nameEx() {
		return admin_name != null ? admin_name : "";
	}
	...
	public void unSetAdmin_name() {
		this.admin_name = null;
	}

	public boolean validateAdmin_name(boolean add) throws ApplicationException {
		if(add && admin_name == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[admin_name]");
	...
	public String getAdmin_emailEx() {
		return admin_email != null ? admin_email : "";
	}
	...
	public void unSetAdmin_email() {
		this.admin_email = null;
	}

	public boolean validateAdmin_email(boolean add) throws ApplicationException {
		if(add && admin_email == null)
			throw new ApplicationException(ExceptionSeverity.ERROR, "Requierd validation Failed[admin_email]");
	...
	public  Class<?> getResultClass() {return AdminResult.class;};
	public  Class<?> getMessageClass() {return AdminMessage.class;};
	public  Class<?> getHelperClass() {return AdminHelper.class;};
	public  Class<?> getServiceClass() {return AdminService.class;};
}