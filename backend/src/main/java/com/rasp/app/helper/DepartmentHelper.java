 ...
 */
 public class DepartmentHelper extends BaseHelper {
		public DepartmentHelper() {super(new Department());}
		private static DepartmentHelper instance;
		public static DepartmentHelper getInstance() {if (instance == null)	{instance = new DepartmentHelper();register_birecord();} return instance;}
